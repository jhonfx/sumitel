...
invokeTag('captureHead','sitemesh',451,[:],1)
printHtmlPart(16)
createTagBody(1, {->
printHtmlPart(17)
invokeTag('select','g',467,['name':("clientId"),'id':("client_name"),'class':("form-control col-sm-4"),'from':(Cliente.findAll()),'optionKey':("id"),'optionValue':("nombre"),'noSelection':(['':'Seleccione un cliente...'])],-1)
printHtmlPart(18)
...
public static final long LAST_MODIFIED = 1487458345000L
