...
class gsp_sumitel_notaCompletashow_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/notaCompleta/show.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(12)
invokeTag('display','f',22,['bean':("notaCompleta")],-1)
printHtmlPart(12)
createTagBody(2, {->
printHtmlPart(13)
createTagBody(3, {->
...
invokeTag('link','g',25,['class':("edit"),'action':("edit"),'resource':(this.notaCompleta)],3)
printHtmlPart(14)
...
invokeTag('form','g',28,['resource':(this.notaCompleta),'method':("DELETE")],2)
printHtmlPart(17)
})
