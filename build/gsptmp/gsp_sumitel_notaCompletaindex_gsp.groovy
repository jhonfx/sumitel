...
class gsp_sumitel_notaCompletaindex_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/notaCompleta/index.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(11)
invokeTag('table','f',21,['collection':(notaCompletaList)],-1)
printHtmlPart(12)
invokeTag('paginate','g',24,['total':(notaCompletaCount ?: 0)],-1)
printHtmlPart(13)
})
