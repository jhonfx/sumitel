...
class gsp_sumitel_ordenCompraprintOrden_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/ordenCompra/printOrden.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(6)
expressionOut.print(createLink(controller: 'ordenCompra', action:'datosPrintOrden'))
printHtmlPart(7)
})
...
createTagBody(1, {->
printHtmlPart(9)
invokeTag('img','g',85,['dir':("img"),'file':("sumitel.jpeg"),'class':("img-responsive sumitel")],-1)
printHtmlPart(10)
invokeTag('img','g',91,['dir':("img"),'file':("telcel.png"),'class':("img-responsive telcel")],-1)
printHtmlPart(11)
})
...
public static final long LAST_MODIFIED = 1484419881000L
