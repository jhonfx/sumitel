...
class gsp_sumitel_usuarioedit_gsp extends GroovyPage {
...
invokeTag('eachError','g',26,['bean':(this.usuario),'var':("error")],3)
printHtmlPart(19)
})
invokeTag('hasErrors','g',28,['bean':(this.usuario)],2)
printHtmlPart(12)
createTagBody(2, {->
printHtmlPart(20)
invokeTag('hiddenField','g',30,['name':("version"),'value':(this.usuario?.version)],-1)
printHtmlPart(21)
invokeTag('all','f',32,['bean':("usuario")],-1)
printHtmlPart(22)
expressionOut.print(message(code: 'default.button.update.label', default: 'Update'))
printHtmlPart(23)
})
invokeTag('form','g',37,['resource':(this.usuario),'method':("PUT")],2)
printHtmlPart(24)
})
