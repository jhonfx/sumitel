...
createTagBody(1, {->
printHtmlPart(15)
invokeTag('select','g',312,['name':("clientId"),'id':("client_name"),'class':("form-control col-sm-4"),'from':(Cliente.findAll()),'optionKey':("id"),'optionValue':("nombre"),'noSelection':(['':'Seleccione un cliente...'])],-1)
printHtmlPart(16)
...
public static final long LAST_MODIFIED = 1484418640000L
