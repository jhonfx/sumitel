...
invokeTag('captureHead','sitemesh',176,[:],1)
printHtmlPart(0)
createTagBody(1, {->
printHtmlPart(13)
invokeTag('select','g',194,['name':("inventarioId"),'class':("form-control col-md-4"),'id':("inventarioId"),'from':(Inventario.findAll()),'optionKey':("id"),'optionValue':("articulo"),'noSelection':(['':'Seleccione...'])],-1)
printHtmlPart(14)
invokeTag('select','g',206,['name':("proveedorId"),'class':("form-control col-md-4"),'from':(Proveedor.findAll()),'optionKey':("id"),'optionValue':("nombreProveedor"),'noSelection':(['':'Seleccione...'])],-1)
printHtmlPart(15)
...
public static final long LAST_MODIFIED = 1469862310000L
