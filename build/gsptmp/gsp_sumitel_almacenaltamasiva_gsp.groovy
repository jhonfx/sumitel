...
invokeTag('captureHead','sitemesh',370,[:],1)
printHtmlPart(0)
createTagBody(1, {->
printHtmlPart(16)
...
printHtmlPart(20)
invokeTag('select','g',415,['name':("proveedorId"),'id':("proveedorId"),'class':("form-control col-md-4"),'from':(Proveedor.findAll()),'optionKey':("id"),'optionValue':("nombreProveedor"),'noSelection':(['':'Seleccione...'])],-1)
printHtmlPart(21)
...
invokeTag('captureBody','sitemesh',459,[:],1)
printHtmlPart(25)
}
...
public static final long LAST_MODIFIED = 1487424107000L
