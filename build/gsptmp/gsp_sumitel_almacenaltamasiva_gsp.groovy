...
printHtmlPart(20)
invokeTag('select','g',400,['name':("proveedorId"),'id':("proveedorId"),'class':("form-control col-md-4"),'from':(Proveedor.findAll()),'optionKey':("id"),'optionValue':("nombreProveedor"),'noSelection':(['':'Seleccione...'])],-1)
printHtmlPart(21)
...
public static final long LAST_MODIFIED = 1484417223000L
