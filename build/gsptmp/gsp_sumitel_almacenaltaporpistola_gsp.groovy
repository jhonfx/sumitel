...
invokeTag('captureHead','sitemesh',339,[:],1)
printHtmlPart(0)
createTagBody(1, {->
printHtmlPart(14)
...
printHtmlPart(18)
invokeTag('select','g',383,['name':("proveedorId"),'class':("form-control"),'from':(Proveedor.findAll()),'optionKey':("id"),'optionValue':("nombreProveedor"),'noSelection':(['':'Seleccione...'])],-1)
printHtmlPart(19)
