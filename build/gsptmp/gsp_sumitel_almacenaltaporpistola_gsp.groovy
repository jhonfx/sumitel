...
invokeTag('captureHead','sitemesh',385,[:],1)
printHtmlPart(0)
createTagBody(1, {->
printHtmlPart(14)
...
printHtmlPart(18)
invokeTag('select','g',429,['name':("proveedorId"),'class':("form-control"),'from':(Proveedor.findAll()),'optionKey':("id"),'optionValue':("nombreProveedor"),'noSelection':(['':'Seleccione...'])],-1)
printHtmlPart(19)
...
public static final long LAST_MODIFIED = 1484410383000L
