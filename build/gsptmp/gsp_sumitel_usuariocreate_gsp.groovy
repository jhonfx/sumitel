...
class gsp_sumitel_usuariocreate_gsp extends GroovyPage {
...
invokeTag('eachError','g',25,['bean':(this.usuario),'var':("error")],3)
printHtmlPart(18)
})
invokeTag('hasErrors','g',27,['bean':(this.usuario)],2)
printHtmlPart(11)
createTagBody(2, {->
printHtmlPart(19)
invokeTag('all','f',30,['bean':("usuario")],-1)
printHtmlPart(20)
