...
class gsp_sumitel_ordenCompraindex_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/ordenCompra/index.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(11)
invokeTag('table','f',21,['collection':(ordenCompraList)],-1)
printHtmlPart(12)
invokeTag('paginate','g',24,['total':(ordenCompraCount ?: 0)],-1)
printHtmlPart(13)
})
...
public static final long LAST_MODIFIED = 1478947007000L
