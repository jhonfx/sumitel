...
class gsp_sumitel_abonoClienteindex_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/grails-app/views/abonoCliente/index.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(11)
invokeTag('table','f',21,['collection':(abonoClienteList)],-1)
printHtmlPart(12)
invokeTag('paginate','g',24,['total':(abonoClienteCount ?: 0)],-1)
printHtmlPart(13)
})
